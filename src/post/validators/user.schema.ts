...
export const userFieldSchema = z.enum(userSchema.keyof()._def.values);

export type TUser = z.infer<typeof userSchema>;
export type TUserAttribute = z.infer<typeof userFieldSchema>;
export type TTokenPayload = Pick<TUser, 'id'>;

export const USER_PUBLIC_FIELDS: TUserAttribute[] = [
  'id',
  'name',
  'avatarUrl',
  'email',
